module.exports = {
    ...
    /* Search */
    SEARCH_NO_MATCHED_DATA: '일치하는 데이터가 없습니다.',
    SEARCH_READ_ALL_SUCCESS: '검색 성공!',
    SEARCH_READ_ALL_FAIL: '검색 실패.',

    /* Image 불러오기 */
    GET_IMAGE_ALL_FAIL: '이미지 불러오기 실패',
    GET_IMAGE_ALL_SUCCESS: '이미지 불러오기 성공',
}